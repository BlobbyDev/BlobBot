...
module.exports = {
    ...
    callback: async(client, interaction) => {
        ...
        const attach = new AttachmentBuilder(img, "triggered.gif");

        await interaction.reply({files: [attach]})
    },

    name: 'triggered-avatar',
    description: "Converts a user's avatar into triggered affect",
    options: [
      {
        name: 'target-user',
        description: 'User you want to triggered avatar',
